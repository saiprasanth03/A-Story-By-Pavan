    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      >
        ...
        >
          ...
          <h1 className="font-oswald font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white uppercase tracking-widest leading-none mb-6">
            {aboutContent?.title || 'Our Story'}
          </h1>
          <div className="w-20 h-[2px] bg-[#C9A227] mx-auto mb-8 shadow-[0_0_10px_rgba(201,162,39,0.8)]"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24 border-b border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <h2 className="font-oswald text-3xl md:text-5xl text-white uppercase tracking-widest leading-tight">
              Crafting Timeless <span className="text-[#C9A227]">Visual Stories</span>
            </h2>
            ...
            {siteConfig.parentCompany.enabled && (
              <div className="p-6 bg-white/5 border border-white/10 rounded-lg backdrop-blur-sm">
                <a 
                  ...
                  className="text-white hover:text-[#C9A227] transition-colors flex items-center justify-between text-sm font-sans tracking-wide"
                >
                  <span><strong>{siteConfig.brand.name}</strong> is a proud subsidiary of <strong>{siteConfig.parentCompany.name}</strong></span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 flex-shrink-0 text-[#C9A227]"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                </a>
              </div>
            )}
          </motion.div>
          ...
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#C9A227]/10 rounded-full blur-3xl pointer-events-none"></div>
            <h3 className="font-oswald text-xl text-[#C9A227] uppercase tracking-[0.2em] mb-6">
              Studio Features
            </h3>
              ...
              <ul className="space-y-4">
                {aboutContent.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start text-sm font-sans tracking-wide text-gray-300">
                    <span className="w-2 h-2 bg-[#C9A227] rounded-full mt-2 mr-4 flex-shrink-0 shadow-[0_0_8px_rgba(201,162,39,0.8)]"></span>
                    <span>{feature}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="mt-10 pt-6 border-t border-white/10">
              <a 
                href="/gallery" 
                className="inline-flex items-center gap-3 text-xs font-oswald text-white uppercase tracking-[0.3em] hover:text-[#C9A227] transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24">
        <div className="text-center mb-16">
          <span className="font-oswald text-xs text-[#C9A227] uppercase tracking-[0.5em] mb-2 block">
            Meet The Visionaries
          </span>
          <h2 className="font-oswald font-bold text-4xl md:text-5xl text-white uppercase tracking-widest">
            The Team
          </h2>
          <div className="w-16 h-[2px] bg-[#C9A227] mx-auto mt-4"></div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            {teamMembers.map((member, index) => (
              <motion.div 
                ...
                className="group cursor-default bg-[#0a0a0a] border border-white/5 p-4 rounded-sm hover:border-[#C9A227]/30 transition-all duration-500"
              >
                <div className="aspect-[3/4] relative overflow-hidden mb-6 bg-[#111]">
                  {member.imageUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-gray-600 font-oswald text-sm uppercase tracking-widest">
                      {member.name}
                    </div>
                  )}
                ...
                <h3 className="text-2xl font-oswald text-white uppercase tracking-widest mb-1 group-hover:text-[#C9A227] transition-colors">{member.name}</h3>
