    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-gray-500/30 overflow-x-hidden relative">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.6 }} className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-16 mt-2">
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                <span className="text-gray-400 font-mirage uppercase tracking-widest text-xs mb-1">Packages Start From Just</span>
                <span className="text-gray-200 font-mirage text-3xl sm:text-4xl">₹3,999/-</span>
              </div>
      ...
      <section className="py-24 bg-[#050505] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-3xl sm:text-5xl font-mirage uppercase tracking-widest mb-4">What We Do Best</h2>
      ...
      <section className="py-24 border-t border-white/5 overflow-hidden">
        <div className="px-6 lg:px-12 mb-12 flex flex-col items-center">
            <h2 className="font-mirage font-light text-3xl md:text-4xl uppercase tracking-[0.2em] text-white">Our Best Clicks</h2>
        </div>
...
\n      {/* 5. WHY PARENTS LOVE OUR STUDIO & PURE COMFORT */}
      ...
      <section className="py-24 border-t border-white/5 overflow-hidden">
        <div className="px-6 lg:px-12 mb-12 flex flex-col items-center">
            <h2 className="font-mirage font-light text-3xl md:text-4xl uppercase tracking-[0.2em] text-white">Memorable Client Stories</h2>
        </div>
      ...
      <section className="py-24 bg-[#050505] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-mirage uppercase tracking-widest mb-4">Investment</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-white to-transparent mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {activePackages.length > 0 ? (
              activePackages.map((pkg, i) => (
                ...
                >
                  <h3 className="text-xl font-mirage uppercase tracking-widest mb-4">{pkg.name}</h3>
                  {pkg.price && (
                    <div className="text-4xl font-mirage mb-6 text-white group-hover:scale-105 transition-transform origin-left">
                      ₹{pkg.price}
                    </div>
                  )}
                  {pkg.features && (
      ...
      <section className="relative py-32 flex items-center justify-center text-center">
        ...
        >
          <h2 className="text-4xl sm:text-6xl font-mirage uppercase tracking-widest mb-6">Affordable Premium Baby Shoot</h2>
